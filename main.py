...
# ── FLOWERS_DATA ──────────────────────────────────────────────────────────────
FLOWERS_DATA = {
    1:  {'id': 1,  'name': 'Букет з ромашок',             'price': 1200,  'old_price': None,
    ...
    2:  {'id': 2,  'name': 'Букет з альстромерій',         'price': 1150, 'old_price': None,
    ...
    3:  {'id': 3,  'name': 'Букет з хризантем та лілій',   'price': 1100,  'old_price': None,
    ...
    4:  {'id': 4,  'name': 'Букет з хризантем та альстромерій', 'price': 950, 'old_price': None,
         'image': '/static/images/img_12.png',
    ...
    5:  {'id': 5,  'name': 'Квіткова композиція', 'price': 5000, 'old_price': None,
         'image': '/static/images/img_4.jpg',
         'description': 'Вишукана композиція у білому кошику — поєднання ніжності білих хризантем і яскравих рожевих троянд. Свіжа зелень евкаліпта додає природної гармонії, а декоративний напис створює святковий акцент. Ідеальний подарунок для особливих моментів.',
         'composition': 'Троянди, хризантеми, евкаліпт, декоративна зелень', 'size': '60x45 см',
         'colors': 'Рожево‑біла з зеленими акцентами', 'freshness': '5–7 днів',
         'badge': 'Преміум', 'badge_class': 'premium', 'category': 'composition', 'gallery': []},
    6:  {'id': 6,  'name': 'Продуктова композиція',    'price': 6500, 'old_price': None,
         'image': '/static/images/img_5.jpg',
         'description': 'Оригінальна чоловіча композиція з улюблених смаколиків — сир, горішки, снеки та ковбасні делікатеси, оформлені у стильному боксі з червоно‑золотими стрічками. Ідеальний подарунок для справжнього гурмана, який цінує смачні деталі й гарний настрій..',
         'composition': 'Cир, ковбасні вироби, горішки, снеки, сухарики, декоративна зелень', 'size': '50x40 см',
         'colors': 'червоно‑золота з жовтими та зеленими акцентами.', 'freshness': 'продукти фабричного пакування, термін придатності 12–20 днів.',
         'badge': None, 'badge_class': '', 'category': 'composition', 'gallery': []},
    7:  {'id': 7,  'name': 'Весільна композиція',   'price': 3000, 'old_price': None,
         'image': '/static/images/img_6.jpg',
         'description': 'Вишукана квіткова композиція у світлих тонах — поєднання білих лілій, ніжних хризантем, еустоми та дрібних ромашок, доповнених соковитою зеленню. Оформлена святковими стрічками й декоративним написом, вона символізує чистоту, ніжність та гармонію. Ідеальний вибір для весільної церемонії чи прикраси банкетної зали.',
         'composition': 'лілії, хризантеми, еустома, ромашки, декоративна зелень', 'size': '45x40 см',
         'colors': 'біло‑жовта з зеленими акцентами', 'freshness': '7–10 днів',
         'badge': 'Новинка', 'badge_class': 'new', 'category': 'composition', 'gallery': []},
    8:  {'id': 8,  'name': 'Траурна композиція',     'price': 2000, 'old_price': None,
         'image': '/static/images/img_7.png',
         'description': 'Стримана траурна композиція у плетеному кошику — поєднання білих хризантем і ніжної блакитної гіпсофіли, прикрашене чорною стрічкою з написом. Контраст кольорів передає глибоку повагу, спокій і світлу пам’ять.',
         'composition': 'білі хризантеми, блакитна гіпсофіла, декоративна зелень', 'size': '60x50 см',
         'colors': 'біло‑блакитна з чорними та жовтими акцентами.', 'freshness': '7–10 днів',
